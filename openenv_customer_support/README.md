...
- A reproducible OpenAI baseline script
...
Run:
```bash
docker run --rm -e HF_TOKEN="$HF_TOKEN" -e OPENAI_MODEL="gpt-4o-mini" openenv-customer-support
```
...
Your exact values depend on model/version and API behavior. Output format:
